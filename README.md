...
5. Within the terminal, run the following command:  
  ```
  conda create -n undercover -c conda-forge python=3.8.2 pandas=1.2.3 geopandas=0.10.2 numpy=1.22.4 contextily=1.1.0 seaborn=0.11.1 matplotlib=3.3.3 shapely=1.7.0 alphashape=1.3.1
  ```
