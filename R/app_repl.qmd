...
re_vio.mod <- glmmTMB(policeUC_arrest_bin ~ cl_miniquart_sw + cl_miniquarter + 
                        ...
                        (1 | CACODE), data = panel_dat3hr, family="gaussian") 
...
Compiling this file will take roughly `r round(time.taken, 0)` minute due to the convergence time needed for the `glmmTMB` package.